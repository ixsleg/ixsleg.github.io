...
//Задание 2:
const heigthRectangle = 40;
const widthRectangle = 70;
const squareRectangle = heigthRectangle * widthRectangle;
...
const time = 2,
    speedOfFirst = 95,
    speedOfSecond = 114;
const distance = speedOfSecond + speedOfFirst * time;
...
switch(number){
    case number < 20:
        console.log('number меньше 20');
        break;
    case number > 50:
        console.log('number больше 50');
        break;
    default:
        console.log('number больше 20, и меньше 50');
}